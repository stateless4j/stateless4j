...
public class TriggerWithParametersTests {
    ...
    public void DescribesUnderlyingTrigger() {
        TriggerWithParameters1<String, Trigger> twp = new TriggerWithParameters1<>(Trigger.X, String.class);
    ...
    public void TooFewParametersDetected() {
        TriggerWithParameters2<String, String, Trigger> twp = new TriggerWithParameters2<>(Trigger.X, String.class, String.class);
